...
export const ClipboardIcon: React.FC<React.SVGProps<SVGSVGElement>> = () => (
	<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path d="M10.5 14L17 14" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path d="M7 14H7.5" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path d="M7 10.5H7.5" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path d="M7 17.5H7.5" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path d="M10.5 10.5H17" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path d="M10.5 17.5H17" stroke="#297fe4" strokeWidth="1.5" strokeLinecap="round" />
		<path
